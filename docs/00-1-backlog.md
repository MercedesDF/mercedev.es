...
- [2.1,2.2] **2.3 Mercí v0:** `docs/03-merci-v0.md` (Contrato de comportamiento) — **creada (v0), pendiente de completar**.
...
- [2.x] **3.1 Arquitectura:** `docs/04-home-estructura.md` — **creada (v0), pendiente de completar**.
...
- [2.x] **6.1 Plantilla:** `docs/05-Cuaderno-de-Bitacora-template.md` — **creada (v0), pendiente de completar**.
...
## 9) Epic: Laboratorio
- [2.x] **9.1 Plantilla Proyecto:** `docs/06-proyecto-template.md` — **creada (v0), pendiente de completar**.
